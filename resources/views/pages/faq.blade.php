<x-main-layout>
    <x-slot:title>
        {{ config('app.name') }}/{{ __('Pages') . '/' . __('FAQ') }}
        </x-slot>
        <style>
            .header-bottom {
                margin-bottom: 0;
                        ...
                        <div class="frequently-content">
                            <div class="frequently-desc">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec id erat sagittis,
                                    faucibus
                                    metus malesuada, eleifend turpis. Mauris semper augue id nisl aliquet, a porta
                                    lectus
                                    mattis. Nulla at tortor augue. In eget enim diam. Donec gravida tortor sem, ac
                                    fermentum
