                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="product-details-view-content pt-60">
                            <div class="product-info">
                                ...
                                <span
                                    class="product-details-ref">{{ __('Category: ') . $product->product_type_items->{'name_' . app()->getLocale()} }}</span>
                                ...
                                <div class="product-desc">
                                    <p>
                                        <span>{{ $product->{'short_text_' . app()->getLocale()} }}
                                        </span>
                                    </p>
                                </div>

                                @if ($product->colors->count())
                                    <div class="product-variants" style="height: 80px">
                ...
                <div class="tab-content">
                    ...
                    <div id="product-details" class="tab-pane" role="tabpanel">
                        <div class="product-details-manufacturer">
                            <p>{{ $product->{'short_text_' . app()->getLocale()} }}</p>
                        </div>
                    </div>
                                ...
                                @foreach ($product->comments as $comment)
                                    <div class="border p-3 my-2">
                                        ...
                                        <div class="comment-review">
                                            ...
                                            <ul class="rating">
                                                @php
                                                    ...
                                                    $i = 0;
                                                    $r = 5 - $comment->rate->star;
                                                    for ($i = 1; $i <= $r; $i++) {
                                                        echo '<li class="no-star"><i class="fa fa-star-o"></i></li>';
                                                    }
                                                @endphp
                                            </ul>
                                        </div>
                                        <div class="comment-author-infos pt-25">
                                            ...
                                            <em>{{ $comment->created_at->isoFormat('LL') }}</em>
                                        </div>
